...
@Component({
  selector: "app-subjecthomeworkteacher",
  templateUrl: "./subjecthomeworkteacher.component.html",
  styleUrls: ["./subjecthomeworkteacher.component.css"],
})
export class SubjecthomeworkteacherComponent implements OnInit {
  ...
  listOfActiveHomework() {
    this.homeworkService
      .getAllActiveHomeworksForTeacher(
        Number(this.route.snapshot.paramMap.get("subjectId")),
        this.theActiveHomeworkPageNumber - 1,
        this.theActiveHomeworkPageSize
      )
      .subscribe((data) => {
