...
@Component({
  selector: 'app-update-user-teacher',
  templateUrl: './update-user-teacher.component.html',
  styleUrls: ['./update-user-teacher.component.css']
})
export class UpdateUserTeacherComponent implements OnInit {
  ...
  mapForm() {
    ...
    this.validateForm.controls["twitchNick"].setValue(this.updateUserOld.twitchNick);
  }
